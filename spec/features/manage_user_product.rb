...
feature 'Manage User Product',type: :feature do

  before(:each) do
    login_admin('doej@test.com')
  end

  describe "User Product", :type => :feature, :js => true do
    ...
    it "#manages user products" do
      ...
      page.should have_content('User product was successfully created.')
      ...
      page.should have_content('User product was successfully updated.')
      ...
      visit admin_user_products_path
      click_on "Delete"
      page.should have_content('User product was successfully destroyed.')
